...
const [Number,setNumber] = useState("")
 ...
 <>
 {!close ? (
     <div className="window fixed bg-black/30 w-full h-screen z-[999999999999999] flex justify-center items-center top-0 left-0">
     <div className="container p-[50px] rounded-2xl w-[500px] h-fit fixed bg-white">
