  ...
  return (
    <div className="max-w-sm md:max-w-5xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20">
      ...
      <div className="flex justify-between flex-col py-4">
          ...
          <div className="rates mt-[10px] mb-[20px] text-[22px]  flex text-orange-400">
                {Array.from(Array(testimonials[active].rates) , (e,i) => (
                    <GoStarFill key={i} />
                ))
            }
                </div>
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-9 w-9 cursor-pointer rounded-full bg-gray-100 dark:bg-neutral-800 flex items-center justify-center group/button"
            >
