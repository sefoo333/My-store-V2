...
function Footer() {
    ...
    const pages = ["Home" , "products" , "Categories" , "Testemionals" , "Tops"]
...
<div className="text-blue-500">
      ...
      >
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
           {pages.map((e) => (
            <li key={e}>
            <a href="#" className="text-gray-700 transition hover:opacity-75"> {e} </a>
          </li>
           ))}
          </ul>
        </div>
      ...
      <p className="text-xs text-gray-500">&copy; {new Date().getFullYear()}. Sefoo Store. All rights reserved.</p>
    </div>
  </footer>
  )
}
